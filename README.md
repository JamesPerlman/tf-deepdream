...
====================
Explaining deep dream algorithm to artists (based on TensorFlow example).

thanks to [Alexander Mordvintsev](mailto:moralex@google.com)

This Jupyter notebook is a detailed demonstration of a number of Convolutional Neural Network
...
[using nbviewer](http://nbviewer.jupyter.org/github/artistic-ai/deepdream-tensorflow/blob/master/deepdream.ipynb)
service.
